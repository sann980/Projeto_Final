 ...
 * @author Conservix
 */
public class Mae extends Dados{

    public Mae(String nomem, String ruam, int numerom, String bairrom, double rgm, 
                String orgaoExpedidorm, String dataDeExpedicaom, double cpfm, 
                String profissaom) {
        this.setNome(nomem);
        this.setRua(ruam);
        this.setNumero(numerom);
        this.setBairro(bairrom);
        this.setRg(rgm);
        this.setOrgaoExpedidor(orgaoExpedidorm);
        this.setDataDeExpedicao(dataDeExpedicaom);
        this.setCpf(cpfm);
        this.setProfisao(profissaom);
    }
