 ...
 * @author Conservix
 */
public class ResponsavelContratual extends Dados{

    public ResponsavelContratual(String nomer, double rgr, double cpfr, String profissaor) {
        this.setNome(nomer);
        this.setRg(rgr);
        this.setCpf(cpfr);
        this.setProfisao(profissaor);
    }
